...
/**
 * Assistant CreateWorkspace model
 */
class CreateWorkspaceModel extends ServiceModel {
     ...
     */
    function __construct($name, $description = '', $language = self::LANGUAGE_ENGLISH,  $intents = [], $entities = [], $dialog_nodes = [], $counterexamples = [], $metadata = NULL, $learning_opt_out = true) {
