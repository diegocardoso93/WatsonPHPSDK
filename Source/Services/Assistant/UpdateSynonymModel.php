...
/**
 * Assistant UpdateSynonym model
 */
class UpdateSynonymModel extends ServiceModel {
     ...
     * @name(new_synonym)
     *
     * The new text of the synonym.
     *
     * @var string
     */
    protected $_new_synonym;
     ...
     */
    function __construct($workspace_id, $entity, $value, $synonym, $new_synonym) {
        
        $this->setWorkspaceId($workspace_id);
        $this->setEntity($entity);
        $this->setValue($value);
        $this->setSynonym($synonym);
        $this->setNewSynonym($new_synonym);
    }
    ...
    /**
     * Get the text of the new synonym.
     *
     * @return array
     */
    public function getNewSynonym() {
        return $this->_new_synonym;
    }
    
    /**
     * Set the text of the new synonym.
     *
     * @param $val array
     */
    public function setNewSynonym($val) {
        $this->_new_synonym = $val;
    }
